...
public class SlidersCardFragment extends CardFragment {
    ...
    private List<Card> populateDataset() {
        ...
        dataset.add(new HeadlineBodyCard(0, TYPE_PRIMARY_HEADLINE_BODY_2, getString(R.string.fragment_sliders), getString(R.string.fragment_sliders_txt)));
        return dataset;
    }
}
