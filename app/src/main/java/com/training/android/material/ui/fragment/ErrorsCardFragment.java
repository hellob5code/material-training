...
public class ErrorsCardFragment extends CardFragment {
    ...
    private List<Card> populateDataset() {
        ...
        dataset.add(new HeadlineBodyCard(0, TYPE_PRIMARY_HEADLINE_BODY_2, getString(R.string.fragment_errors), getString(R.string.fragment_errors_txt)));
        return dataset;
    }
}
