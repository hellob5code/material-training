...
public class ButtonsRecyclerFragment extends RecyclerFragment {
    ...
    private List<Card> populateDataset() {
        ...
        dataset.add(new RichAreaHeadlineOneBodyCard(0, R.layout.btn_raised, "Raised button", null));
        dataset.add(new RichAreaHeadlineOneBodyCard(0, R.layout.btn_flat, "Flat button", null));
        dataset.add(new HeadlineOneBodyThreeButtonCard(0, "Buttons in dialogs", "Use ink buttons on dialogs to prevent too many layers of dimension.",
                "Example #1",
                null));
