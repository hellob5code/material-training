...
public class ProgressAndActivityCardFragment extends CardFragment {
    ...
    private List<Card> populateDataset() {
        ...
        dataset.add(new HeadlineBodyCard(0, TYPE_PRIMARY_HEADLINE_BODY_2, getString(R.string.fragment_progress_and_activity), getString(R.string.fragment_progress_and_activity_txt)));
        return dataset;
    }
}
