...
public class NavigationalTransitionsCardFragment extends CardFragment {
    ...
    private List<Card> populateDataset() {
        ...
        dataset.add(new HeadlineBodyCard(0, TYPE_PRIMARY_HEADLINE_BODY_2, getString(R.string.fragment_navigational_transitions), getString(R.string.fragment_navigational_transitions_txt)));
        return dataset;
    }
}
