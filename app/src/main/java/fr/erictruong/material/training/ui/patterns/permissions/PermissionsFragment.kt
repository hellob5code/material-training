package fr.erictruong.material.training.ui.patterns.permissions
...
class PermissionsFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.permissions), displayColor = colorPrimary,
                body = getString(R.string.permissions_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
