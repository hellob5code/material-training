package fr.erictruong.material.training.ui.components.data_tables
...
class DataTablesFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.data_tables), displayColor = colorPrimary,
                body = getString(R.string.data_tables_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
