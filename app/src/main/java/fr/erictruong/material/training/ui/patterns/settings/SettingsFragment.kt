package fr.erictruong.material.training.ui.patterns.settings
...
class SettingsFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.settings), displayColor = colorPrimary,
                body = getString(R.string.settings_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
