package fr.erictruong.material.training.ui.components.sliders
...
class SlidersFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.sliders), displayColor = colorPrimary,
                body = getString(R.string.sliders_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
