package fr.erictruong.material.training.ui.components.chips
...
class ChipsFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.chips), displayColor = colorPrimary,
                body = getString(R.string.chips_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
