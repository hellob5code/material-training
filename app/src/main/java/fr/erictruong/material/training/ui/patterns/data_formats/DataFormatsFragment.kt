package fr.erictruong.material.training.ui.patterns.data_formats
...
class DataFormatsFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(display = getString(R.string.data_formats), displayColor = colorPrimary))
