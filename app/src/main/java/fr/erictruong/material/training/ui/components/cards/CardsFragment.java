...
public class CardsFragment extends BaseCardFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        cards.add(new HeadlineBodyItem.Builder()
                ...
                .headline("Card with action area, rich media and supporting text")
                .button1("Sample", null)
                .build());
        cards.add(new HeadlineBodyItem.Builder()
                .viewType(VIEW_TYPE_HEADLINE_PRIMARY_BODY1_THREE_BUTTON)
                .headline("Card with action areas 1 and 2, optional header, rich media, supporting text, and supplemental actions")
                .button1("Sample", null)
                .build());
        cards.add(new HeadlineBodyItem.Builder()
                .viewType(VIEW_TYPE_HEADLINE_PRIMARY_BODY1_THREE_BUTTON)
                .headline("Card with action areas 1, 2, 3 and 4, optional header, rich media, and supplemental actions")
                .button1("Sample", null)
                .build());
        cards.add(new HeadlineBodyItem.Builder()
                .viewType(VIEW_TYPE_HEADLINE_PRIMARY_BODY1_THREE_BUTTON)
                .headline("Card with action areas 1 and 2, optional header, supporting text and supplemental actions")
                .button1("Sample", null)
                .build());
        cards.add(new HeadlineBodyItem.Builder()
                .viewType(VIEW_TYPE_HEADLINE_PRIMARY_BODY1_THREE_BUTTON)
