...
public class PinnedTabBarActivity extends AppCompatActivity {

    @Bind(R.id.pinned_tab_bar_drawer_layout) DrawerLayout drawerLayout;
    @Bind(R.id.pinned_tab_bar_toolbar) Toolbar toolbar;
    @Bind(R.id.pinned_tab_bar_tabs) TabLayout tabs;
    @Bind(R.id.pinned_tab_bar_view_pager) ViewPager viewPager;

    public static void start(Context context) {
        Intent starter = new Intent(context, PinnedTabBarActivity.class);
