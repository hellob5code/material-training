...
class AvatarCheckboxListControlActivity : RecyclerActivity() {
    ...
    val adapter = AvatarCheckboxAdapter()
    ...
    class AvatarCheckboxAdapter() : RecyclerView.Adapter<ViewHolder>() {
    ...
    class ViewHolder : AvatarCheckBoxViewHolder, Bindable<DummyModel> {
