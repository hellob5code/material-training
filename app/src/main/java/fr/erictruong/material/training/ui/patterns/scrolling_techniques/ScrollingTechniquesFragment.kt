package fr.erictruong.material.training.ui.patterns.scrolling_techniques
...
class ScrollingTechniquesFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(display = getString(R.string.scrolling_techniques), displayColor = colorPrimary))
