...
class ProgressAndActivityFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.progress_and_activity), displayColor = colorPrimary,
                body = getString(R.string.progress_and_activity_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
