...
class BottomNavigationFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.bottom_navigation), displayColor = colorPrimary,
                body = getString(R.string.bottom_navigation_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
