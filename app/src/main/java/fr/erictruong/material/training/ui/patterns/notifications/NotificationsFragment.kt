package fr.erictruong.material.training.ui.patterns.notifications
...
class NotificationsFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.notifications), displayColor = colorPrimary,
                body = getString(R.string.notifications_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
