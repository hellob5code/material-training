...
class AuthenticMotionFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.authentic_motion), displayColor = colorPrimary,
                body = getString(R.string.authentic_motion_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
