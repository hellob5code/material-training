...
public class IconExpandListControlActivity extends RecyclerActivity {
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, IconExpandListControlActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < ITEM_COUNT; i++) {
            MaterialListItem item = new IconExpandItem.Builder()
                    .id(i)
