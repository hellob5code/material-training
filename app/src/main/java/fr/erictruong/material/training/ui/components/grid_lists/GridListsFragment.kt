package fr.erictruong.material.training.ui.components.grid_lists
...
class GridListsFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.grid_lists), displayColor = colorPrimary,
                body = getString(R.string.grid_lists_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
