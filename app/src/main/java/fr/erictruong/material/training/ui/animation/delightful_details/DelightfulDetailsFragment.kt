package fr.erictruong.material.training.ui.animation.delightful_details
...
class DelightfulDetailsFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.delightful_details), displayColor = colorPrimary,
                body = getString(R.string.delightful_details_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
