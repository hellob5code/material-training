package fr.erictruong.material.training.ui.components.buttons
...
class ButtonsFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.buttons), displayColor = colorPrimary,
                body = getString(R.string.buttons_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
