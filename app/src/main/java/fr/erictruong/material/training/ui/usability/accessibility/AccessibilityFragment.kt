package fr.erictruong.material.training.ui.usability.accessibility
...
class AccessibilityFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.accessibility), displayColor = colorPrimary,
                body = getString(R.string.accessibility_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
