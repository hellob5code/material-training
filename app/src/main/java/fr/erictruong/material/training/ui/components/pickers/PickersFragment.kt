package fr.erictruong.material.training.ui.components.pickers
...
class PickersFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.pickers), displayColor = colorPrimary,
                body = getString(R.string.pickers_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
