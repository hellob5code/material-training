...
class IconExpandListControlActivity : RecyclerActivity() {
    ...
    class IconExpandAdapter() : RecyclerView.Adapter<ViewHolder>() {
    ...
    class ViewHolder : IconExpandViewHolder, Bindable<DummyModel> {

        val actionStub: ActionStub
        val textStub: TextStub
        val iconStub: IconStub
        val expandStub: ExpandStub
