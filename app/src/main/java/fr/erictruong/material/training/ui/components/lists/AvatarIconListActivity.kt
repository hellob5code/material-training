...
class AvatarIconListActivity : RecyclerActivity() {
    ...
    private fun mapOneLineItem(model: DummyModel): MaterialListItem = AvatarIconItem(
            id = model.id,
    ...
    private fun mapTwoLineItem(model: DummyModel): MaterialListItem =  AvatarIconItem(
            id = model.id,
    ...
    private fun mapThreeLineItem(model: DummyModel): MaterialListItem =  AvatarIconItem(
            id = model.id,
