package fr.erictruong.material.training.ui.patterns.search
...
class SearchFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(display = getString(R.string.search), displayColor = colorPrimary))
