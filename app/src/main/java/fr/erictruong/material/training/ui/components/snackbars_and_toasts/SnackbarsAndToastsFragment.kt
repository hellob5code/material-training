...
class SnackbarsAndToastsFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.snackbars_and_toasts), displayColor = colorPrimary,
                body = getString(R.string.snackbars_and_toasts_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
