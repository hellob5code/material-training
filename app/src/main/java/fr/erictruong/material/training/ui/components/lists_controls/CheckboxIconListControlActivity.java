...
public class CheckboxIconListControlActivity extends RecyclerActivity {
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, CheckboxIconListControlActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < ITEM_COUNT; i++) {
            MaterialListItem item = new CheckBoxIconItem.Builder()
                    .id(i)
