...
import kotlinx.android.synthetic.main.activity_pinned_tab_bar.pinned_tab_bar_drawer_layout as drawerLayout
import kotlinx.android.synthetic.main.activity_pinned_tab_bar.pinned_tab_bar_tabs as tabs
import kotlinx.android.synthetic.main.activity_pinned_tab_bar.pinned_tab_bar_toolbar as toolbar
import kotlinx.android.synthetic.main.activity_pinned_tab_bar.pinned_tab_bar_view_pager as viewPager

class PinnedTabBarActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pinned_tab_bar)
