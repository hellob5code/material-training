...
class AvatarSubheaderMediaBody1ActionsActivity : RecyclerActivity() {
    ...
    class ViewHolder(parent: ViewGroup, viewType: Int) : AvatarSubheaderMediaBody1ActionsViewHolder(parent, viewType), Bindable<Int> {
