package fr.erictruong.material.training.ui.patterns.navigation
...
class NavigationFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.navigation), displayColor = colorPrimary,
                body = getString(R.string.navigation_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
