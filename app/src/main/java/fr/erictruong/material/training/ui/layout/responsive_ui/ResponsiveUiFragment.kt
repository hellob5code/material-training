package fr.erictruong.material.training.ui.layout.responsive_ui
...
class ResponsiveUiFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.responsive_ui), displayColor = colorPrimary,
                body = getString(R.string.responsive_ui_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
