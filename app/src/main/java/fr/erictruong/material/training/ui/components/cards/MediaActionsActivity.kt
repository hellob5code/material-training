...
import fr.erictruong.android.cards.holder.MediaActionsViewHolder
import fr.erictruong.android.core.activity.RecyclerActivity
import fr.erictruong.material.training.R
import org.jetbrains.anko.dimen

class MediaActionsActivity : RecyclerActivity() {
    ...
    class ViewHolder(parent: ViewGroup, viewType: Int) : MediaActionsViewHolder(parent, viewType), Bindable<Int> {
