package fr.erictruong.material.training.ui.style.icons
...
class IconsFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(display = getString(R.string.icons), displayColor = colorPrimary))
