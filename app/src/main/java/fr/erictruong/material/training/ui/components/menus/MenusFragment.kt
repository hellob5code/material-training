package fr.erictruong.material.training.ui.components.menus
...
class MenusFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.menus), displayColor = colorPrimary,
                body = getString(R.string.menus_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
