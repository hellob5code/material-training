...
class SelectionFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.selection), displayColor = colorPrimary,
                body = getString(R.string.selection_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
