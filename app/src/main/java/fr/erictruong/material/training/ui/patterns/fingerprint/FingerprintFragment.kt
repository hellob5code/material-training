...
class FingerprintFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.fingerprint), displayColor = colorPrimary,
                body = getString(R.string.fingerprint_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
