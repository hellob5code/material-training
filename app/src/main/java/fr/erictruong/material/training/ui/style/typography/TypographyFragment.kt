...
class TypographyFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.typography), displayColor = colorPrimary,
                body = getString(R.string.typography_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
