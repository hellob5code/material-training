...
class UnitsAndMeasurementsFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.units_and_measurements), displayColor = colorPrimary,
                body = getString(R.string.units_and_measurements_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
