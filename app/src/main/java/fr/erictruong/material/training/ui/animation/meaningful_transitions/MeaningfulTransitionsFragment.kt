...
class MeaningfulTransitionsFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.meaningful_transitions), displayColor = colorPrimary,
                body = getString(R.string.meaningful_transitions_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
