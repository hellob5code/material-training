...
import fr.erictruong.material.training.ui.components.lists.MaterialListAdapter.AvatarViewType;
...
public class AvatarItem extends TextItem {
    ...
    public static final class Builder {
        ...
        public Builder() {
            this.id = NO_ID;
            this.viewType = VIEW_TYPE_ONE_LINE_AVATAR;
        }
        ...
        public Builder viewType(@AvatarViewType int viewType) {
