package fr.erictruong.material.training.ui.components.dialogs
...
class DialogsFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.dialogs), displayColor = colorPrimary,
                body = getString(R.string.dialogs_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
