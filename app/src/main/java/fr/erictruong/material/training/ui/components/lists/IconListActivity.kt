...
class IconListActivity : RecyclerActivity() {
    ...
    private fun mapOneLineItem(model: DummyModel): MaterialListItem = IconItem(
            id = model.id,
    ...
    private fun mapTwoLineItem(model: DummyModel): MaterialListItem =  IconItem(
            id = model.id,
    ...
    private fun mapThreeLineItem(model: DummyModel): MaterialListItem = IconItem(
            id = model.id,
