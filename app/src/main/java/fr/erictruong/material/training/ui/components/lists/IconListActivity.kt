...
class IconListActivity : RecyclerActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter = IconAdapter(intent.getIntExtra("extra_list_view_type", 0))
    }

    class IconAdapter(val viewType: Int = 0) : RecyclerView.Adapter<ViewHolder>() {
    ...
    class ViewHolder : IconViewHolder, Bindable<Int> {
