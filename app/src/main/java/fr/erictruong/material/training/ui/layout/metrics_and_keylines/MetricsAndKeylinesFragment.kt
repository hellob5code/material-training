package fr.erictruong.material.training.ui.layout.metrics_and_keylines
...
class MetricsAndKeylinesFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(display = getString(R.string.metrics_and_keylines), displayColor = colorPrimary))
