...
class TooltipsFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.tooltips), displayColor = colorPrimary,
                body = getString(R.string.tooltips_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
