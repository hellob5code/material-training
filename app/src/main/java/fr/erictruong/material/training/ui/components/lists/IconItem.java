...
import fr.erictruong.material.training.ui.components.lists.MaterialListAdapter.IconViewType;
...
public class IconItem extends TextItem {
    ...
    public static final class Builder {
        ...
        public Builder() {
            this.id = NO_ID;
            this.viewType = VIEW_TYPE_ONE_LINE_ICON;
        }
        ...
        public Builder viewType(@IconViewType int viewType) {
