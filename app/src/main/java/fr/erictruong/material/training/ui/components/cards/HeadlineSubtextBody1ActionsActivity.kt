...
import fr.erictruong.android.cards.holder.HeadlineSubtextBody1ActionsViewHolder
import fr.erictruong.android.core.activity.RecyclerActivity
import fr.erictruong.material.training.R
import org.jetbrains.anko.dimen

class HeadlineSubtextBody1ActionsActivity : RecyclerActivity() {
    ...
    class ViewHolder(parent: ViewGroup, viewType: Int) : HeadlineSubtextBody1ActionsViewHolder(parent, viewType), Bindable<Int> {
