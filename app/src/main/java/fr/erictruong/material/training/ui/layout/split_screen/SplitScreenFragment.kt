package fr.erictruong.material.training.ui.layout.split_screen
...
class SplitScreenFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.split_screen), displayColor = colorPrimary,
                body = getString(R.string.split_screen_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
