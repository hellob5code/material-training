package fr.erictruong.material.training.ui.layout.principles
...
class PrinciplesFragment : BaseCardFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        cards.add(DisplayBodyItem(
                display = getString(R.string.principles), displayColor = colorPrimary,
                body = getString(R.string.principles_txt), bodyAppearance = R.style.TextAppearance_AppCompat_Body2))
