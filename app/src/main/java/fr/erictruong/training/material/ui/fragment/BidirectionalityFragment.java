...
public class BidirectionalityFragment extends MaterialTrainingNavigationDrawerFragment {

    @Override
    protected List<Card> populateDataset() {
        List<Card> dataset = new ArrayList<>();
        dataset.add(new HeadlineBodyCard(0, TYPE_PRIMARY_HEADLINE_BODY_2, getString(R.string.fragment_bidirectionality), getText(R.string.fragment_bidirectionality_txt)));
        return dataset;
    }
}
