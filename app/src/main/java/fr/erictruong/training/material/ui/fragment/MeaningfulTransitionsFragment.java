...
public class MeaningfulTransitionsFragment extends MaterialTrainingNavigationDrawerFragment {
    ...
    protected List<Card> populateDataset() {
        ...
        dataset.add(new HeadlineBodyCard(0, TYPE_PRIMARY_HEADLINE_BODY_2, getString(R.string.fragment_meaningful_transitions), getString(R.string.fragment_meaningful_transitions_txt)));
        return dataset;
    }
}
