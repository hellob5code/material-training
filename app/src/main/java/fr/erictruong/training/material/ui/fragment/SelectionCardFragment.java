...
public class SelectionCardFragment extends CardFragment {
    ...
    private List<Card> populateDataset() {
        ...
        dataset.add(new HeadlineBodyCard(0, Card.TYPE_PRIMARY_HEADLINE_BODY_2, getString(R.string.fragment_selection), getString(R.string.fragment_selection_txt)));
        return dataset;
    }
}
