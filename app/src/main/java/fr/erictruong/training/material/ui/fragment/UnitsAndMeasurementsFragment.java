...
public class UnitsAndMeasurementsFragment extends MaterialTrainingNavigationDrawerFragment {
    ...
    protected List<Card> populateDataset() {
        ...
        dataset.add(new HeadlineBodyCard(0, Card.TYPE_PRIMARY_HEADLINE_BODY_2, getString(R.string.fragment_units_and_measurements), getString(R.string.fragment_units_and_measurements_txt)));
        return dataset;
    }
}
