...
public class TypographyCardFragment extends CardFragment {
    ...
    private List<Card> populateDataset() {
        ...
        dataset.add(new HeadlineBodyCard(0, Card.TYPE_PRIMARY_HEADLINE_BODY_2, getString(R.string.fragment_typography), null));
        return dataset;
    }
}
